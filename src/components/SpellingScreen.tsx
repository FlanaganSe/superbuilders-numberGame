		...
		<div className="flex flex-col items-center gap-4">
			...
			<div className="flex flex-col items-center gap-6 rounded-2xl bg-black/55 px-8 py-6">
				...
				<div className="flex items-center gap-3">
					<p className="font-body text-2xl text-slate-300">Spell the word:</p>
				...
				{isScanning && detectedLetters.length > 0 && (
					<div className="flex gap-2">
						<span className="font-body text-xl text-slate-300">
							Camera sees:
						</span>
						{detectedLetters.map((letter, i) => (
							<span
								...
								key={i}
								className="font-display text-2xl text-success-400"
							>
								{letter}
							</span>
						))}
