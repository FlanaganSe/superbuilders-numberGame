...
The PRD is at `.Codex/plans/prd.md`. Read it first.

If `.Codex/plans/research.md` already exists (from external tools like Codex or Gemini),
read it and instruct the researcher to focus on areas NOT already covered.

The researcher will write its findings to `.Codex/plans/research.md`
